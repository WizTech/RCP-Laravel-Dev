                            ...
                            <ul class="d-flex justify-content-center">
                                ...
                                <?php else: ?>
                                    ...
                                    <li class="mr-3"><button
                                                data-campusid="<?php echo $campus['id'] ?>"
                                                class="btn btn-success btn-xs fa fa-pencil-square-o editCampus"></button></li>
                                    <!--<li class="mr-3"><a href="<?php /*echo url('rcpadmin/campus/' . $campus['id']) */?>"
                                                        class="btn btn-success btn-xs fa fa-edit"  title="Campus" target="_blank"></a></li>-->
                                    <li class="mr-3"><a
