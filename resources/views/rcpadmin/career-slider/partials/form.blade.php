                    ...
                    <div class="tab-content mt-12 " id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="form-group">
                                <div class="form-row">
                                    @if (!empty($careerslider['slider_image']))
                                        <div class="col-md-6 mb-6">
                                            {!! Form::label(' Slider Image ',null,['class' => 'col-form-label']) !!}
                                                <span>
                                            <img style="float: inside;" height="60" width="60"
                                                 src="{{ env('APP_URL').'storage/uploads/careerSlider/'.$careerslider['slider_image']}}">
                                        </span>
                                        </div>
                                        <div class="col-md-6 mb-6">
                                            {!! Form::label('Update Image',null,['class' => 'col-form-label']) !!}
                                            {!! Form::file('slider_image',null,['class' => 'custom-file-label']) !!}
                                        </div>
                                    @else
                                        <div class="col-md-6 mb-6">
                                            {!! Form::label('Slider Image',null,['class' => 'col-form-label']) !!}
                                    ...
                                    @endif
                                        <div class="col-md-6 mb-6">
                                            {!! Form::label('Slider Type',null,['class' => 'col-form-label']) !!}
                                            {!! Form::text('slider_type',null,['class' => 'form-control', 'required']) !!}
                                        </div>
                                    <div class="col-md-6 mb-6">
                                        {!! Form::label('Heading One',null,['class' => 'col-form-label']) !!}
                                        {!! Form::text('slider_heading_one',null,['class' => 'form-control'], 'required') !!}
                                    </div>
                                        <div class="col-md-6 mb-6">
                                            {!! Form::label('Heading Two',null,['class' => 'col-form-label']) !!}
                                            {!! Form::text('slider_heading_two',null,['class' => 'form-control'], 'required') !!}
                                        </div>
                                    <div class="col-md-6 mb-6">
                                        {!! Form::label('Slider Minute',null,['class' => 'col-form-label']) !!}
                                        {!! Form::text('slider_minute',null,['class' => 'form-control', 'required']) !!}
                                    </div>
                                        <div class="col-md-6 mb-6">
