    ...
    <div class="col-12 mt-5">
      <div class="card">
        <div class="card-body">
          ...
          <a href="{{ url('rcpadmin/property/create')}}" class="btn btn-outline-dark header-title">Add Property</a>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <ul class="d-flex justify-content-center">
                        <li class="mr-3"><a href="{{ url('rcpadmin/property/'.$property['id'])}}"
                                            class="text-secondary"><i
                              class="fa fa-edit" title="Detail"></i></a></li>

                        <li class="mr-3"><a href="{{ url('rcpadmin/property/'.$property['id'].'/floorplan')}}"
                                            class="text-secondary"><i
                              class="fa fa-university" title="Floorplans"></i></a></li>
