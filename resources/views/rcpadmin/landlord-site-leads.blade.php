...
@section('content')
    <div class="row">
        <div class="col-12 mt-5">
            <div align="center">
                <form action="{{url('rcpadmin/landlord-site-leads')}}" method="post">
                    {{ csrf_field() }}
                    ...
                    <select class="filter-box" name="landlord_id">
                        <option value="All">Landlords</option>
                        @if(!empty($leads['landlords']))
                            @foreach($leads['landlords'] as $landlord)
