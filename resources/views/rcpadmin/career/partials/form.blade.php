                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 mb-6">
                                        ...
                                        <?php
                                        if (!empty($careers['career_type'])):  ?>
                                        <select class="custom-select" name="career_type" id="">
                                            <option value=""> Select</option>
                                            <?php foreach ($careers['career_type'] as $career): ?>
                                            <option value="<?= $career['careers_type'] ?>"><?= $career['careers_type'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <?php endif; ?>

                                        <?php if (!empty($careertypes)):  ?>
                                        <select class="custom-select" name="career_type" id="">
                                            <option value=""> Select</option>
                                            <?php foreach ($careertypes as $careertype): ?>
                                            <option value="<?= $careertype['careers_type'] ?>"><?= $careertype['careers_type'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <?php endif; ?>
