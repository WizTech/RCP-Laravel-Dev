            ...
            <div align="center">
                <form action="{{url('rcpadmin/lead-export')}}" method="get">
                    ...
                    <select class="filter-box" name="campus_id">
                        ...
                        @if(!empty($phoneLeads['campuses']))
                            @foreach($phoneLeads['campuses'] as $campus)
                ...
                <div class="card-body">
                    <div class="table-responsive datatable-dark">
                        <table class="text-center table">
                            ...
                            <tbody>
                            @if(!empty($phoneLeads['leads']))
                                @foreach( $phoneLeads['leads'] as $lead)
                                    <tr>
                        ...
                        @if(isset($phoneLeads['leads']) && count($phoneLeads['leads']) > 0)
                            {{$phoneLeads['leads']->links()}}
                            Showing {{$phoneLeads['leads']->firstItem()}} to {{$phoneLeads['leads']->lastItem()}}
                            of {{$phoneLeads['leads']->total()}}
                            Entities
                        @endif
                    </div>
                </div>
