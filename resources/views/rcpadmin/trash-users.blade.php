    ...
    <div class="col-12 mt-5">
      <div class="card">
        <div class="card-body">
          ...
          --}}
          <a href="{{ url('rcpadmin/users')}}" class="btn btn-outline-dark header-title">User Manager</a>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="d-flex justify-content-center">
                        ...
                        <li>
                          <form method="POST" action="{{$user['id']}}/restoreUser">
                            {{ csrf_field() }}

                            <div class="form-group">
                              <input type="submit" class="btn btn-success btn-xs active"
                                     value="Restore">
                            </div>
                          </form>
                          </a>
