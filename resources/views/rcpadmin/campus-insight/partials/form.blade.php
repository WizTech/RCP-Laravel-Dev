                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-6 mb-6">
                                        {!! Form::label('Campus Insight Title',null,['class' => 'col-form-label']) !!}
                                        {!! Form::text('title',null,['class' => 'form-control']) !!}
                                    </div>
                                    <div class="col-md-6 mb-6">
                                        {!! Form::label('Campus',null,['class' => 'col-form-label']) !!}
                                        <?php
                                        if (!empty($campusInight['campus_list'])):  ?>
                                        <select class="custom-select" name="campus_id" id="">
                                            <option value=""> Select</option>
                                            <?php foreach ($campusInight['campus_list'] as $camp): ?>
                                    ...
                                    @if (!empty($campusInight['campus_insight']['pdf_file']))
                                        <div class="col-md-6 mb-6">
                                            {!! Form::label('Update PDF File',null,['class' => 'col-form-label']) !!}
                                            {!! Form::file('pdf_file',null,['class' => 'custom-file-label']) !!}
                                        </div>
                                    @else
                                        <div class="col-md-6 mb-6">
                                            {!! Form::label('Upload PDF File',null,['class' => 'col-form-label']) !!}
                                            {!! Form::file('pdf_file',null,['class' => 'custom-file-label']) !!}
                                        </div>
                                    @endif
                                    <div class="col-md-6 mb-6">
