    ...
    <div class="col-12 mt-5">
      <div class="card">
        <div class="card-body">
          ...
          <a href="{{ url('rcpadmin/unsubcribers/create')}}" class="btn btn-outline-dark header-title">Add Email</a>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="d-flex justify-content-center">
                        <li class="mr-3"><a href="{{ url('rcpadmin/unsubcribers/'.$email['id'])}}"
                                            class="text-secondary"><i
                              class="fa fa-edit"></i></a></li>
                        <li><a data-admin-id="{{$email['id']}}" href="{{url('rcpadmin/unsubcribers/'.$email['id'])}}"
