...
@section('breadcrumbs')
  <div class="breadcrumbs-area clearfix">
    ...
    <ul class="breadcrumbs pull-left">
      ...
      <li><span>Template Manager</span></li>
    </ul>
  </div>
@stop
@section('content')
    ...
    <div class="col-12 mt-5">
      <div class="card">
        <div class="card-body">
          ...
          <a href="{{ url('rcpadmin/template/create')}}" class="btn btn-outline-dark header-title">Add Template</a>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <ul class="d-flex justify-content-center">
                          <li class="mr-3"><a href="{{ url('rcpadmin/template/'.$template['id'])}}"
                                              class="text-secondary"><i
                                class="fa fa-edit"></i></a></li>
                          <li><a data-admin-id="{{$template['id']}}" href="{{url('rcpadmin/template/'.$template['id'])}}"
