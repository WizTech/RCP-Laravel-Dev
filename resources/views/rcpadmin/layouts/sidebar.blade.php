        ...
        @if($modules)
            ...
            <li>
                ...
                <ul class="collapse">
                    ...
                    <li class="child-element"><a href="{{ url('rcpadmin/').'/landlord-site-leads'}}">Landlord Site
                            Leads</a></li>
                    <li class="child-element"><a href="{{ url('rcpadmin/').'/landlord-total-leads'}}">Landlord Total
                            Leads</a>
                    </li>
                    ...
                    <li class="child-element"><a href="{{ url('rcpadmin/').'/properties-count'}}">Properties Count</a>
                    </li>
                    <li class="child-element"><a href="{{ url('rcpadmin/').'/active-properties'}}">Active Properties</a>
                    </li>
                    <li class="child-element"><a href="{{ url('rcpadmin/').'/export-landlord-active-properties'}}">Landlord
                            Active
                            Properties</a></li>
                    ...
                    <li class="child-element"><a href="{{ url('rcpadmin/').'/imitation-email'}}">Imitation Email</a>
                    </li>
                    <li class="child-element"><a href="{{ url('rcpadmin/').'/expiring-property'}}">Property Expiring</a>
                    </li>
                    <li class="child-element"><a href="{{ url('rcpadmin/').'/leads-per-company'}}">Leads Per Company</a>
                    </li>
