...
@section('breadcrumbs')
  <div class="breadcrumbs-area clearfix">
    ...
    <ul class="breadcrumbs pull-left">
      ...
      <li><span>Feature Manager</span></li>
    </ul>
  </div>
@stop
@section('content')
    ...
    <div class="col-12 mt-5">
      <div class="card">
        <div class="card-body">
          ...
          <a href="{{ url('rcpadmin/feature/create')}}" class="btn btn-outline-dark header-title">Add Feature</a>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="d-flex justify-content-center">
                        ...
                        <li><a data-admin-id="{{$feature['id']}}" href="{{url('rcpadmin/feature/'.$feature['id'])}}"
