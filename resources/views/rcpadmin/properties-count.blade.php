...
@section('breadcrumbs')
  <div class="breadcrumbs-area clearfix">
    ...
    <ul class="breadcrumbs pull-left">
      ...
      <li><a href="{{'rcpadmin/properties-count'}}">Properites Count</a></li>
    </ul>
  </div>
@stop
@section('content')
  <div class="row">
    <div class="col-12 mt-5">
      <div align="left">
           <form action="{{url('rcpadmin/properties-count')}}" method="post">
               {{ csrf_field() }}
          ...
          <div class="table-responsive datatable-dark">
            <table class="text-center table">
              ...
              <tr>
                ...
                <th>Campus</th>
                <th>Free Properites</th>
                <th>Paid Properites</th>

              </tr>
              </thead>
              <tbody>
              @if(!empty($leads['count']))
                @foreach( $leads['count'] as $lead)
                  <tr>
                    <td>{{$lead->name}} </td>
