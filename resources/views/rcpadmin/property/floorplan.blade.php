...
@section('content')
  <div class="row">
    ...
    <div class="col-12 mt-5">
      <div class="card">
        <div class="card-body">
          {!! Form::model($floorplans,['method'=>'POST', 'files' => true],['action' => ['rcpadmin/PropertyController@update_floorplan',$propertyData['id']] ,'class' => 'col s12']) !!}
          {!! Form::hidden('id') !!}
          {!! Form::hidden('property_id',$propertyData['id']) !!}
          @include('rcpadmin.property.partials.floorplan-form',['buttonText'=>'Update'])
          {!! Form::close() !!}
        </div>
      </div>
    </div>
