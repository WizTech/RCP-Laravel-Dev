          ...
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile"
                 aria-selected="false">Neighborhood</a>
            </li>
              ...
              <div class="form-group">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6 mb-6">
                    ...
                    {!! Form::text('homepage_h2',null,['class' => 'form-control']) !!}
                  </div>
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
              <div class="form-group">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6 mb-6">
                    {!! Form::label('H1',null,['class' => 'col-form-label']) !!}
                    {!! Form::text('neighborhood_h1',null,['class' => 'form-control']) !!}
                  </div>
                  <div class="col-md-6 mb-6">
                    {!! Form::label('H2',null,['class' => 'col-form-label']) !!}
                    {!! Form::text('neighborhood_h2',null,['class' => 'form-control']) !!}
                  </div>
                  <div class="col-md-12 mb-12">
                    {!! Form::label('Description',null,['class' => 'input-group-text']) !!}
                    {!! Form::textarea('neighborhood_description',null,['class' => 'form-control']) !!}
