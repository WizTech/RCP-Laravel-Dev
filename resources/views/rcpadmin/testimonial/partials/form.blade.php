                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-6 mb-6">
                                        {!! Form::label('Person Name',null,['class' => 'col-form-label']) !!}
                                    ...
                                    <div class="col-md-6 mb-6">
                                        {!! Form::label('Market',null,['class' => 'col-form-label']) !!}
                                        {!! Form::text('market',null,['class' => 'form-control']) !!}
                                    </div>
                                    <div class="col-md-6 mb-6">
                                        {!! Form::label('Photo',null,['class' => 'col-form-label']) !!}
                                    ...
                                    <div class="col-md-12 mb-6">
                                        {!! Form::label('Testimoial Text',null,['class' => 'input-group-text']) !!}
