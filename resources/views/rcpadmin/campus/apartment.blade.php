...
@section('content')
  <div class="row">
    ...
    <div class="col-12 mt-5">
      <div class="card">
        <div class="card-body">
          {!! Form::model($campus,['method'=>'POST', 'files' => true],['action' => ['rcpadmin/CampusController@update_apartment',$campus['id']] ,'class' => 'col s12']) !!}
          {!! Form::hidden('id') !!}
          {!! Form::hidden('campus_id',$campus['id']) !!}
          @include('rcpadmin.campus.partials.apartment-form',['buttonText'=>'Update'])
          {!! Form::close() !!}
        </div>
      </div>
    </div>
