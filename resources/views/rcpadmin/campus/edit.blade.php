    ...
    <div class="col-12 mt-5">
      <div class="card">
        <div class="card-body">
          ...
          {!! Form::model($campus,['method'=>'PATCH'],['action' => ['rcpadmin/CampusController@update',$campus['id']] ,'class' => 'col s12']) !!}
          {!! Form::hidden('id') !!}
          @include('rcpadmin.campus.partials.form',['buttonText'=>'Update','linked_campuses'=>$linked_campuses])
          {!! Form::close() !!}
        </div>
      </div>
    </div>
