          ...
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home"
                 aria-selected="true">Guide</a>
            </li>


            <li class="nav-item">
              <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile"
                 aria-selected="false">Roommates</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact"
                 aria-selected="false">Subleases</a>
            </li>
          </ul>
              ...
              <div class="form-group">
                ...
                <div class="form-row">
                  <div class="col-md-6 mb-6">
                    ...
                    @if (!empty($campus['image']))

                      <img style="float: right;" height="60" width="60"

                           src="{{ env('APP_URL').'public/storage/guide/'.$campus['image']}}">
                  ...
                  <div class="col-md-6 mb-6">
                    ...
                    {!! Form::text('guide_title',null,['class' => 'form-control']) !!}
                  </div>
                  <div class="col-md-6 mb-6">
                  ...
                  <div class="col-md-6 mb-6">
                    {!! Form::label('Rent',null,['class' => 'input-group-text']) !!}
                    {!! Form::textarea('rent',null,['class' => 'form-control']) !!}

                  </div>
                  <div class="col-md-6 mb-6">
                    {!! Form::label('Life',null,['class' => 'input-group-text']) !!}
                    {!! Form::textarea('life',null,['class' => 'form-control']) !!}
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
              <div class="form-group">
                ...
                <div class="form-row">
                  <div class="col-md-6 mb-6">
                    {!! Form::label('Title',null,['class' => 'col-form-label']) !!}
                    {!! Form::text('roommate_title',null,['class' => 'form-control']) !!}
                  </div>
                  <div class="col-md-6 mb-6">
                    {!! Form::label('H1',null,['class' => 'col-form-label']) !!}
                    {!! Form::text('roommate_h1',null,['class' => 'form-control']) !!}
                  </div>
                  <div class="col-md-6 mb-6">
                    {!! Form::label('Meta Description',null,['class' => 'input-group-text']) !!}
                    {!! Form::textarea('roommate_description',null,['class' => 'form-control']) !!}

                  </div>
                  <div class="col-md-6 mb-6">
                    {!! Form::label('Copy',null,['class' => 'input-group-text']) !!}
                    {!! Form::textarea('roommate_copy',null,['class' => 'form-control']) !!}
            ...
            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
              <div class="form-group">
                ...
                <div class="form-row">
                  <div class="col-md-6 mb-6">
                    {!! Form::label('Title',null,['class' => 'col-form-label']) !!}
                    {!! Form::text('sublease_title',null,['class' => 'form-control']) !!}
                  </div>
                  <div class="col-md-6 mb-6">
                    {!! Form::label('H1',null,['class' => 'col-form-label']) !!}
                    {!! Form::text('sublease_h1',null,['class' => 'form-control']) !!}
                  </div>
                  <div class="col-md-6 mb-6">
                    {!! Form::label('Meta Description',null,['class' => 'input-group-text']) !!}
                    {!! Form::textarea('sublease_description',null,['class' => 'form-control']) !!}

                  </div>
                  <div class="col-md-6 mb-6">
                    {!! Form::label('sublease_Copy',null,['class' => 'input-group-text']) !!}
                    {!! Form::textarea('sublease_copy',null,['class' => 'form-control']) !!}
