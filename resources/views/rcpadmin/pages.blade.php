...
@section('content')
    <div class="row">
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                  {{--  <a href="{{ url('rcpadmin/pages/create')}}" class="btn btn-outline-dark header-title">Add
                        Pages</a>--}}
                    <div class="table-responsive datatable-dark">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="d-flex justify-content-center">
                                                <li class="mr-3"><a href="{{ url('rcpadmin/pages/'.$n['id'])}}"
                        ...
                        @if(isset($pages) && count($pages) > 0)
                            {{$pages->links()}}
                            Showing {{$pages->firstItem()}} to {{$pages->lastItem()}} of {{$pages->total()}} Entities
                        @endif
                    </div>
                </div>
            </div>
